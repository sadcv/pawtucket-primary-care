...
function BookAppointment() {
  return (
    <div className="BookAppointment"style={{height: "40rem", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center"}}>
      <p style={{fontSize: "24px", marginBottom: "1rem", textAlign: "center"}}>Thank you for your interest in booking an appointment with</p>
      ...
      <p style={{fontSize: "18px", marginBottom: "1rem", width: "80%", textAlign: "center"}}>Please call <b>(401) 556-3694</b> or email <b>pawtucket.primary.care@gmail.com</b> to schedule an appointment.</p>
